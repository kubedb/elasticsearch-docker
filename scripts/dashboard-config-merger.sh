...
for FILE_DIR in "$CONFIG_DIR"/*; do
    ...
    if [[ "$EXTENSION" == "yml" ]]; then
        ...
        # In default kibana.yml, fields like `elasticsearch.username`, `elasticsearch.password` etc. are set.
